...
Gem::Specification.new do |s|
  ...
  s.files = ["ext/swift/db/mysql/datetime.c", "ext/swift/db/mysql/main.c", "ext/swift/db/mysql/typecast.c", "ext/swift/db/mysql/adapter.c", "ext/swift/db/mysql/result.c", "ext/swift/db/mysql/statement.c", "ext/swift/db/mysql/common.c", "ext/swift/db/mysql/typecast.h", "ext/swift/db/mysql/datetime.h", "ext/swift/db/mysql/gvl.h", "ext/swift/db/mysql/result.h", "ext/swift/db/mysql/common.h", "ext/swift/db/mysql/statement.h", "ext/swift/db/mysql/adapter.h", "ext/swift/db/mysql/extconf.rb", "test/helper.rb", "test/test_ssl.rb", "test/test_encoding.rb", "test/test_adapter.rb", "test/test_async.rb", "lib/swift/db/mysql.rb", "lib/swift-db-mysql.rb", "README.md", "CHANGELOG"]
